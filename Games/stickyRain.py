...
def bsGetGames():
    return [StickyRainGame]

def bsGetLevels():
    return [bs.Level('Sticky Rain',displayName='${GAME}',gameType=StickyRainGame,settings={},previewTexName='rampagePreview'),
            bs.Level('Epic Sticky Rain',displayName='${GAME}',gameType=StickyRainGame,settings={'Epic Mode':True},previewTexName='rampagePreview')]

class StickyRainGame(bs.TeamGameActivity):
