...
def _onPartyMemberPress(self,clientID,isHost,widget):
    ...
    p = bsUI.PopupMenuWindow(position=widget.getScreenSpaceCenter(),
                        ...
                        choices=['kickOrg', "kick", "remove", "kill", "ban", "unban", "amnesty", "knock", "curse", "heal", "shield", "punch", "freeze", "thaw", "headless", "celebrate", "list", "headlessall", "healall", "shieldall", "punchall", "killall", "knockall", "freezeall", "thawall", "curseall", "celebrateall", "slow", "camera", "end", "help"],
                        choicesDisplay=[kickStr, "Kick", "Remove", "Kill", "Ban", "Unban", "Amnesty", "Knock", "Curse", "Heal", "Shield", "Punch", "Freeze", "Thaw", "Headless", "Celebrate", "List", "HeadlessAll", "HealAll", "ShieldAll", "PunchAll", "KillAll", "KnockAll", "FreezeAll", "ThawAll", "CurseAll", "CelebrateAll", "Slow", "Camera", "End", "Help"],
